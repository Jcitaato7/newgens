<%@ Page Title="Photo Slide Photos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/CMSAdmin.Master" CodeBehind="photo-slide-photos.aspx.vb" Inherits="tfsCMS._gallery_photo_slide_photos" Theme="admin" %>
                ...
                <CommandItemSettings ExportToPdfText="Export to Pdf" AddNewRecordText="Add Photo">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="AlternateText" 
                            FilterControlAltText="Filter AlternateText column" HeaderText="File Name" 
                        ...
                        <div class="adminPopUp">
                            ...
                            <table> 
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtAlternateText" runat="server" MaxLength="150" CssClass="formtextarea" TextMode="MultiLine" Columns="54" Rows="2" 
                                            Text='<%# Bind("AlternateText")%>' />
                                    </td>
                                </tr>  
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDescription" runat="server" MaxLength="500" CssClass="formtextarea" TextMode="MultiLine" Columns="54" Rows="4" 
                                            Text='<%# Bind("Description")%>' /><br /><br />
                                    </td>
                                </tr> 
                                <tr>
                                    <td>
