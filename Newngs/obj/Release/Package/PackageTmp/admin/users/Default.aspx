    ...
    <div style="padding:10px">
        ...
        LoginCreatedUser="False" Height="170px" Width="488px"   
            ...
            <StepNavigationTemplate>
                ...
                <MailDefinition Priority="High" Subject="Techfount CMS User account" BodyFileName="~/admin/users/emailbody.txt"   />
            <WizardSteps>
...
&nbsp;</td>
              ...
              <tr><td></td><td><div style="border: 1px solid #C0C0C0; font-size:11px; width:95%;padding:5px;margin-top:5px">
                ...
                <b>Editor</b> - Able to edit page but it has to be set first by the Contributor/Super Admin in the page settings<br />
           </div></td></tr>
        <tr>
            <td align="right" style="vertical-align: top">
                &nbsp;</td>
