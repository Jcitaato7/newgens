       ...
       <asp:FormView ID="FormView1" runat="server" DataKeyNames="webpageid" 
                                ...
                                <td colspan="2" class="t2">Page Settings</td><td ></td><td></td><td></td><td></td></tr>
                                    ...
                                    <tr><td><b>Page Type</b> </td>
                                        ...
                                        <td colspan='2'><%# IIf(Eval("webpage_type") <> 2, "<b>Page URL</b>&nbsp;<a href='" + IIf(Eval("webpage_type") = 1, ResolveUrl(Eval("weburl")), Eval("weburl")) + "' target='_blank' style='text-decoration:none'>" + Eval("weburl") + " (<b>Preview</b>)</a>", "")%>
