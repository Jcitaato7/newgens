...
<%@ Register src="~/webparts/products/wpproductslist.ascx" tagname="ProductsList" tagprefix="techCMS" %>
      ...
      <div id="content">
        <div id="grid-2a">
            <asp:WebPartZone ID="Left"   runat="server" Width="100%" >
                <ZoneTemplate>
                    <techCMS:ProductsList ID="ProductsList1" title="Products" runat="server" />
                </ZoneTemplate>
            </asp:WebPartZone>
        </div>
        <div id="grid-2b">
